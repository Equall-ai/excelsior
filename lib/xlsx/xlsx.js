      ...
      if (!entry.dir) {
        ...
        switch (entryName) {
          ...
          case 'xl/workbook.xml': {
            ...
            model.sheets = (workbook && workbook.sheets) || [];
            model.definedNames = (workbook && workbook.definedNames) || [];
            model.views = (workbook && workbook.views) || [];
            model.properties = (workbook && workbook.properties) || {};
            model.calcProperties = (workbook && workbook.calcProperties) || {};
            break;
          }
          ...
          case 'docProps/app.xml': {
            ...
            model.company = appProperties ? appProperties.company : '';
            model.manager = appProperties ? appProperties.manager : '';
            break;
          }
